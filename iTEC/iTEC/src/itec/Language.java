...
public class Language extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("Language.title")); // NOI18N
        setLocationByPlatform(true);
        setResizable(false);

        jLabel1.setText(bundle.getString("Language.jLabel1.text")); // NOI18N

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "EN" }));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/logo-up.png"))); // NOI18N
        jLabel3.setText(bundle.getString("Language.jLabel3.text")); // NOI18N
