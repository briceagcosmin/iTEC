...
public class MainForm extends javax.swing.JFrame {
    ...
    public MainForm() {
        ...
        obj = conn.getCategories();
        listModel.clear();
        for(int i=0; i<conn.getSizeCat();i++){
            listModel.addElement(obj[i]);
        }
         ...
         MouseListener mouseListener = new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent event){
                ...
                obj2 = conn.getItems(selectedItem);
                for(Object o : obj2){
         ...
         MouseListener ms = new MouseAdapter(){
           @Override
           public void mouseClicked(MouseEvent event){
               String item = (String)list2.getSelectedValue();
               String userName = displayName.getText();
               message = "Ce punctaj acordati ?";
               String val = JOptionPane.showInputDialog(null,message);
               int value = 0,sold = 0;
               if(val != null){
                    value = Integer.parseInt(val);
                        conn.vote(item, userName, value);
                        sold = conn.substraction(userId, value);
                        message2 = "Va multumim, "+userName+"\nAti votat: '"+item+"' cu "+value+" puncte \n"
                            +"Sold Curent: "+sold;
                    JOptionPane.showMessageDialog(null,message2,"Info",JOptionPane.INFORMATION_MESSAGE);
                    displaySold.setText(""+sold);
                    
               }
           }
         };
         list2.addMouseListener(ms);
    }
        ...
        public final void setSold(String sold){
           displaySold.setText(sold);
        }
        ...
        public final void setUsrId(String id){
            userId = id;
        }
    /**
    ...
    private void initComponents() {
        ...
        displaySold = new javax.swing.JLabel();
        displayName = new javax.swing.JLabel();
        jLabel4 = new javax.swing.JLabel();
        displayGroup = new javax.swing.JLabel();
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(bundle.getString("MainForm.jPanel2.border.title"))); // NOI18N
        ...
        displayDate.setText(bundle.getString("MainForm.displayDate.text")); // NOI18N

        displaySold.setText(bundle.getString("MainForm.displaySold.text")); // NOI18N

        displayName.setText(bundle.getString("MainForm.displayName.text")); // NOI18N

        jLabel4.setText(bundle.getString("MainForm.jLabel4.text")); // NOI18N

        displayGroup.setText(bundle.getString("MainForm.displayGroup.text")); // NOI18N
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(bundle.getString("MainForm.jPanel3.border.title"))); // NOI18N
        ...
        jMenuBar1.setName(bundle.getString("MainForm.jMenuBar1.name")); // NOI18N
        ...
        jMenu2.setActionCommand(bundle.getString("MainForm.jMenu2.actionCommand")); // NOI18N
    ...
    private javax.swing.JLabel displayGroup;
    private javax.swing.JLabel displayName;
    private javax.swing.JLabel displaySold;
